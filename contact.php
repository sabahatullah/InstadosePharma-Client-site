...
<head>
    <meta charset="utf-8">
    <title>Contact :: Instadose Pharma</title>
    ...
    <meta property="og:title" content="Contact :: Instadose Pharma">
    ...
    <meta name="twitter:title" content="Contact :: Instadose Pharma">
    ...
    <link type="text/css" href="css/about.css" rel="stylesheet" media="screen" />
    
    <link type="text/css" href="css/contacts.css" rel="stylesheet" media="screen">
    ...
    <script type="application/javascript">
        ...
        var main_map_address = 'Moscow city, 2J, Minskaya str.,<br /> offices 201, 202, 203';
    ...
    <div id="screen" class="big-wrapper">
        ...
        <div class="header">
            <div class="container clearfix">
                <div class="logo js-site-logo"><a href="index.php"><img src="img/logo-black.png" /></a></div>

                <!-- <div class="logo"><a href="/"><img src="img/logo-small2_en.svg" /></a></div> -->
                ...
                <div class="lang-switch">
                    <a class="hidden" href="javascript:;">
                        <div class="rus no-active">рус</div>
                    </a>
...
<div class="breadcrumbs header">
    <div class="container">
        <ul>
            ...
            <li class="active"><a href="#"><span>05</span> Contact</a></li>

        </ul>
        <a target="_blank" class="hidden save-present" href="">download presentation <span>pdf - 3 MB</span></a>
    </div>
</div>
<div id="content" class="content-wrapper">
    ...
    <div class="contacts-block">
        <div class="container">
            ...
            <a class="save-present hidden" target="_blank" href="">download company logo</a>
        </div>

    </div>
    <div class="form-block">
        <div class="container">
            <div class="block-title-small">Feedback</div>
            <div class="block-title">Send us your question<br> or partnership proposal</div>
            <form role="form" method="post" id="" accept-charset="utf-8">
                <label class="input"><span class="placeholder">First name</span><input class="required" type="text" name="name"></label>
                <label class="input"><span class="placeholder">Phone</span><input class="required" maxlength="20" type="text" name="phone"></label>
                <label class="input"><span class="placeholder">E-mail</span><input class="required" type="text" name="email"></label>
                <label class="input"><span class="placeholder">Company</span><input class="required" type="text" name="company"></label>
                <label class="textarea"><span class="placeholder">Your message</span><textarea class="required" name="message"></textarea></label>
                <div style="text-align: right;position: relative">
                    <div class="checkbox js-i-checkbox">
                        <input type="hidden" name="agree" value="1">
                        <i class="active"></i><span>Keep me updated with the industry news and third party offers.</span>
                    </div>
                    <label class="submit"><input type="submit" name="submit" value="Send message"></label>
                </div>
            </form>
        </div>
    </div>
            ...
            <a href="contact">Contacts</a>
                ...
                <div class="subfooter">
                    <div class="container">
                        ...
                        <div class="copyrights">© 2018 «Instadose Pharma»</div>
                    </div>
                </div>
            </div>
    ...
    <noscript>
    <a href="https://www.livechatinc.com/chat-with/10455202/">Chat with us</a>,
